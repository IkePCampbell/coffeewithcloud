...
import picture from "../../img/AboutMePhoto.jpg"
...
export default function About(){
    ...
    return (
        ...
        <div className ="aboutMePage">
                ...
                <p style={{paddingTop:"1%",fontSize:"18px"}}class="container-content">My name is Isaac, and the platinum blonde 🔥 is my wife Sam!</p>
                <p style={{paddingTop:"1%"}}class="container-content"> We got married in the midst of the 2020 pandemic and let me just say how incredible she is and that life is a living dream because of her. Truly is the best and is the the primary inspiration for this blog.</p>
